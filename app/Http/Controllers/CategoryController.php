...
class CategoryController extends Controller
{
    ...
    public function create()
    {
       ...
       return view('backend.category.create')->with(compact('parent_cats'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($status) {
            return redirect()->route('category.index')->with('success','Successfully create category');
        }else
        {
    ...
    public function edit($id)
    {
        ...
        if ($category) {
            return view('backend.category.edit')->with(compact('category','parent_cats'));
        }else
        {
        ...
        if ($category) {
          ...
          if ($status) {
            if (count($child_cat_id)>0) {
               category::shifrChild($child_cat_id);
            }
