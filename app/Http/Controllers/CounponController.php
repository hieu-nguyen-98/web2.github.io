...
class CounponController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.coupon.index')->with(compact('coupons'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($status) {
            return redirect()->route('coupon.index')->with('success','Successfully create category');
        }else
        {
    ...
    public function edit($id)
    {
        ...
        if ($coupon) {
            return view('backend.coupon.edit')->with(compact('coupon'));
        }else
        {
    ...
    public function destroy($id)
    {
       $coupon = Coupon::find($id);
        if ($coupon) {
          ...
          if ($status) {
              return redirect()->route('coupon.index')->with('success','coupon Successfully delete');
          }else
          {
            return back()->with('error','Something went wrong');
          }
