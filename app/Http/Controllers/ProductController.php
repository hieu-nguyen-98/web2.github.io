...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($status) {
            return redirect()->route('product.index')->with('success','Successfully create product');
        }else
        {
    ...
    public function show($id)
    {
        ...
        if ($product) {
            return view('backend.product.view')->with(compact('product'));
        }else
        {
    ...
    public function edit($id)
    {
        $product= Product::find($id);
        if ($product) {
            return view('backend.product.edit')->with(compact('product'));
        }else
        {
            return back()->with('error','Product not found');
        }
