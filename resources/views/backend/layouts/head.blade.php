<meta charset="utf-8">
    ...
    <title>Advance multivendor Ecom || Dashboard</title>
    ...
    <link rel="stylesheet" type="text/css" href=" {{asset('backend/vendor/switch-button-bootstrap/css/bootstrap-switch-button.css')}} ">
